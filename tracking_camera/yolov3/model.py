...
class YOLOvR1(nn.Module):
    def __init__(self, in_channels=3, num_classes=1):
        ...
        self.layers = nn.ModuleList([
            ...
            CNNBlock(16, 32, kernel_size=3, stride=2, padding=1),
            ResidualBlock(32, num_repeats=1),
            CNNBlock(32, 64, kernel_size=3, stride=2, padding=1),
            ResidualBlock(64, num_repeats=2),
            CNNBlock(64, 128, kernel_size=3, stride=2, padding=1),
            ResidualBlock(128, num_repeats=8),
            CNNBlock(128, 256, kernel_size=3, stride=2, padding=1),
            ResidualBlock(256, num_repeats=8),
            CNNBlock(256, 512, kernel_size=3, stride=2, padding=1),
            ResidualBlock(512, num_repeats=4),
            CNNBlock(512, 256, kernel_size=1, stride=1, padding=0),
            CNNBlock(256, 512, kernel_size=3, stride=1, padding=1),
            ResidualBlock(512, use_residual=False, num_repeats=1),
            CNNBlock(512, 256, kernel_size=1, stride=1, padding=0),
            ...
            ResidualBlock(128, use_residual=False, num_repeats=1),
            CNNBlock(128, 64, kernel_size=1, stride=1, padding=0),
            ScalePrediction(64, num_classes=num_classes)
        ])
...
if __name__ == "__main__":
    ...
    model = YOLOvR1(num_classes=num_classes)
